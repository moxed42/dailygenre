...
async function loadData() {
  ...
  function hardDeleteTargetDisplayKey(song) {
    ...
    function deleteFromMetadataQueue(encodedGenreId, encodedKey, mountId) {
      if (!window.confirm('Permanently delete this track from this genre? Use Studio hard delete to remove every copy everywhere. This cannot be undone until you reload without saving.')) return;
